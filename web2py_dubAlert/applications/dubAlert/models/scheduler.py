...
# mail.settings.sender = 'warriorsvslakers@gmail.com'
# mail.settings.login = 'warriorsvslakers@gmail.com:dubnation7!'
#
# import json
...
#     send_email(tester)
#
#     #nba_py.Scoreboard().game_header().to_json()
...
#     if game_id != -1:
#         if game_results(game_id, lal_id) == constants.Outcome.Lose:
#             lal_lose = True
...
# scheduler = Scheduler(db, dict(task=task))